...
namespace custom
{
   ...
   public:
      ...
      list(const A& a = A()) : numElements(0), pHead(nullptr), pTail(nullptr), alloc(a) {}
      list(list <T, A>& rhs, const A& a = A()) : numElements(0), pHead(nullptr), pTail(nullptr), alloc(a)
      {
         *this = rhs;
      }
